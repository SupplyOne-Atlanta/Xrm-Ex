            ...
            getXrmWebApi() {
                if (isOffline() === true) {
                    if (this._isEntityAvailableOffline === undefined) {
                        let offline = Xrm.WebApi.offline;
                        this._isEntityAvailableOffline = offline.isAvailableOffline(this.EntityType);
                        // Xrm.WebApi.isAvailableOffline(this.EntityType);
