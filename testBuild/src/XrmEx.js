            ...
            getXrmWebApi() {
                if (isOffline() === true) {
                    if (this._isEntityAvailableOffline === undefined) {
                        ...
                        //   this.EntityType
                        // );
                        this._isEntityAvailableOffline = (Xrm.WebApi.offline).isAvailableOffline(this.EntityType);
